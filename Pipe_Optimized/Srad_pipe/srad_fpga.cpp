...
int mem_size;															// matrix memory size
    ...
    // 1. set up kernel
        ...
        cl_program cl_srad_extract_program;
      	...
      	cl_srad_extract_program = cl_compileProgram((char *)"./xclbin/krnl_srad.hw_emu.xilinx_aws-vu9p-f1-04261818_dynamic_5_0.xclbin",NULL);
...
//**************************************App-specific transfer from device to host **************
    ...
    cl_errChk(status,"ERROR with clEnqueueReadBuffer",true);
