...
void ForwardSub(cl_context context,float *a, float *b, float *m, int size) {
    ...
    // 1. set up kernel
        ...
        cl_gaussian_program = cl_compileProgram((char *)"./xclbin/krnl_gaus.hw_emu.xilinx_aws-vu9p-f1-04261818_dynamic_5_0.xclbin",NULL);
